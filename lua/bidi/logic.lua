...
---Process a line of text, reversing segments based on a predicate
---@param line string The input line of text
---@param should_reverse_chunk fun(char: string): boolean Predicate to decide if a chunk should be reversed
---@return string
